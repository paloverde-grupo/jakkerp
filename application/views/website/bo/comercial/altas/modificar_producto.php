                ...
                title="Source Title">Para ver el archivo que va a cargar, pulse con el puntero en el boton de "Buscar"</cite>
                                        ...
                                        <fieldset id="moneda_field">
                                            ...
                                            <section class="col col-12" style="width: 50%;">
                                                <label class="input">
                                                    Costo real
                                                    <input required type="number" step="0.0001" value='<?php echo $item->real ?>' onchange="calcular_precio_total()" name="real" id="real">
                                                </label>
                                            </section>
                                            ...
                                            <section class="col col-12" style="width: 50%;">
                                                <label class="input">
                                                    ...
                                                    <input required type="number" step="0.0001" value='<?php echo $item->costo ?>' name="costo" id="costo" onchange="calcular_precio_total()">
                                                </label>
                                            </section>
                                            ...
                                            <section class="col col-12" style="width: 50%;">
                                                <label class="input">
                                                    Costo publico
                                                    <input required type="number" step="0.0001" value='<?php echo $item->costo_publico ?>' name="costo_publico" id="costo_publico" onchange="calcular_precio_total()">
                                                </label>
                                            </section>
                                    ...
                                    <fieldset>
                                        <div class="row">
                                            <section class="col col-6">
                                                <label class="input">
                                                    Costo real con IVA
                                                    <input type="text" value="<?= $real ?>" min="1" max="" name="real_iva" id="real_iva" disabled>
                                                </label>
                                            </section>
                                            <section class="col col-6">
                                                <label class="input">
                            ...
                            <fieldset>
                                ...
                                <section class="col col-12" style="width: 33.4%;">Requiere instalación
                                    <div class="inline-group">
                                        <?php if ($data_merc[0]->instalacion == 1) { ?>
                                            <label class="radio">
                                ...
                                <section class="col col-12" style="width: 33.3%;">Requiere especificación
                                    <div class="inline-group">
                                        <?php if ($data_merc[0]->especificacion == 1) { ?>
                                            <label class="radio">
                                ...
                                <section class="col col-12" style="width: 33.3%;">Requiere producción
                                    <div class="inline-group">
                                        <?php if ($data_merc[0]->produccion == 1) { ?>
                                            <label class="radio">
