                                    ...
                                    <fieldset id="moneda_field">
                                        ...
                                        <section class="col col-2" style="width: 50%;">
                                            <label class="input"> Costo real
                                                <input required type="number"  
                                                       name="real" id="real" 
                                                       value='<?= $item->real ?>' onchange="calcular_precio_total()">
                                            </label>
                                        </section>
                                        ...
                                        <section class="col col-2" style="width: 50%;">
                                            <label class="input">Costo distribuidores 
                                                <input required type="number"
                                                       name="costo" id="costo"                                                       
                                                       value='<?= $item->costo ?>' onchange="calcular_precio_total()">
                                            </label>
                                        </section>
                                        ...
                                        <section class="col col-2" style="width: 50%;">
                                            <label class="input">Costo publico 
                                                <input required type="number"
                                                       ...
                                                       value='<?= $item->costo_publico ?>' onchange="calcular_precio_total()">
                                            </label>
                                        </section>
                                ...
                                <div>
                                    <section style="padding-left: 15px; width: 100%;"
                                        ...
                                        <label class="textarea"> 
                                            <textarea  name="descripcion" rows="3" class="custom-scroll">
                                                    <?php echo $data_merc[0]->Descripcion ?></textarea>
                                        </label>
                                    </section>
