                                    ...
                                    <?php foreach ($archivos as $archivo) { ?>
                                        <tr>
                                            ...
                                            <td class='text-center'>
                                                <a class='txt-color-blue' href='<?php echo $archivo->ruta ?>' 
                                                   title='Descargar' target="_blank">
                                                    <i class='fa fa-download fa-3x'></i></a>
                                                <a class='txt-color-red' style='cursor: pointer;' 
