...
class calculadorBonos extends ctest
{
    ...
    public function testGetAfiliadosPorNivel()
    {
        ...
        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[0];
        $this->runTest(10001, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');

        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[1];
        $this->runTest(10002, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');
        ...
        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[0];
        $this->runTest(10003, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');

        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[1];
        $this->runTest(10004, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');

        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[2];
        $this->runTest(10005, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');

        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[3];
        $this->runTest(10006, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');
        ...
        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[0];
        $this->runTest(10007, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');

        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[1];
        $this->runTest(10008, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');

        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[2];
        $this->runTest(10009, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');

        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[3];
        $this->runTest(10010, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');
        ...
        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[0];
        $this->runTest(10011, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');

        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[1];
        $this->runTest(10012, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');

        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[2];
        $this->runTest(10013, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');

        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[3];
        $this->runTest(10014, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');
        ...
        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[0];
        $this->runTest(10015, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');

        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[1];
        $this->runTest(10016, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');

        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[2];
        $this->runTest(10017, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');

        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[3];
        $this->runTest(10018, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');
        ...
        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[3];
        $this->runTest(10020, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');

        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[4];
        $this->runTest(10029, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');

        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[5];
        $this->runTest(10030, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');
        ...
        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[1];
        $this->runTest(10026, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');
        ...
        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[2];
        $this->runTest(10031, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');

        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[3];
        $this->runTest(10021, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');

        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[4];
        $this->runTest(10022, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');
        ...
        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[2];
        $this->runTest(10027, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');

        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[3];
        $this->runTest(10028, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');
        ...
        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[0];
        $this->runTest(10019, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');

        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[1];
        $this->runTest(10025, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');

        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[2];
        $this->runTest(10032, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');

        $resultado = $afiliados->getIdAfiliadosRed();
        $resultado = $resultado[3];
        $this->runTest(10033, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');
    ...
    public function testGetBonosActivosPorCobrar()
    {
        ...
        $this->runTest(true, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');

        $this->bono->setUpBono(51);
        $resultado = $calculadorBono->isDisponibleCobrar($bono);
        $this->runTest(false, $resultado, 'Test set Base de datos No Esta disponible Para Cobrar porque esta desactivado');

        $this->bono->setUpBono(52);
        $resultado = $calculadorBono->isDisponibleCobrar($bono);
        $this->runTest(false, $resultado, 'Test set Base de datos No Esta disponible Para Cobrar porque no esta vigente');
    ...
    public function testGetUsuariosDeLaRedtestGetUsuariosDeLaRed()
    {
        ...
        $this->runTest(10000, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');
        ...
        $this->runTest(10023, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');

        $resultado = $usuarios[24]->id_afiliado;
        $this->runTest(10024, $resultado, 'Test set Base de datos Esta disponible Para Cobrar');
    ...
    public function testGetUsuarioCumpleCondicionVentasRedBono()
    {
        ...
        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[0]->id_afiliado, $fecha);
        $this->runTest(true, $resultado, 'Test validar si Esta disponible Para Cobrar por Ventas en la red Equilibrada');
        ...
        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[4]->id_afiliado, $fecha);
        $this->runTest(false, $resultado, 'Test validar si Esta disponible Para Cobrar por Ventas en la red Equilibrada');
    ...
    public function testGetUsuarioCumpleCondicionPuntosComisionablesPersonalesBono()
    {
        ...
        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[0]->id_afiliado, $fecha);
        $this->runTest(true, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales ' . $usuarios[0]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[1]->id_afiliado, $fecha);
        $this->runTest(true, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[1]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[2]->id_afiliado, $fecha);
        $this->runTest(false, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[2]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[3]->id_afiliado, $fecha);
        $this->runTest(true, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[3]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[4]->id_afiliado, $fecha);
        $this->runTest(true, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[4]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[5]->id_afiliado, $fecha);
        $this->runTest(true, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[5]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[6]->id_afiliado, $fecha);
        $this->runTest(true, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[6]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[7]->id_afiliado, $fecha);
        $this->runTest(true, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[7]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[8]->id_afiliado, $fecha);
        $this->runTest(false, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[8]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[9]->id_afiliado, $fecha);
        $this->runTest(false, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[9]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[10]->id_afiliado, $fecha);
        $this->runTest(true, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[10]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[11]->id_afiliado, $fecha);
        $this->runTest(true, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[11]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[12]->id_afiliado, $fecha);
        $this->runTest(true, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[12]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[13]->id_afiliado, $fecha);
        $this->runTest(true, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[13]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[14]->id_afiliado, $fecha);
        $this->runTest(true, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[14]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[15]->id_afiliado, $fecha);
        $this->runTest(false, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[15]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[16]->id_afiliado, $fecha);
        $this->runTest(true, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[16]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[17]->id_afiliado, $fecha);
        $this->runTest(true, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[17]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[18]->id_afiliado, $fecha);
        $this->runTest(true, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[18]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[19]->id_afiliado, $fecha);
        $this->runTest(true, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[19]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[20]->id_afiliado, $fecha);
        $this->runTest(true, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[20]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[21]->id_afiliado, $fecha);
        $this->runTest(true, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[21]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[22]->id_afiliado, $fecha);
        $this->runTest(true, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[22]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[23]->id_afiliado, $fecha);
        $this->runTest(false, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[23]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[24]->id_afiliado, $fecha);
        $this->runTest(true, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[24]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[25]->id_afiliado, $fecha);
        $this->runTest(true, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[25]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[26]->id_afiliado, $fecha);
        $this->runTest(false, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[26]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[27]->id_afiliado, $fecha);
        $this->runTest(false, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[27]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[28]->id_afiliado, $fecha);
        $this->runTest(false, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[28]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[29]->id_afiliado, $fecha);
        $this->runTest(true, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[29]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[30]->id_afiliado, $fecha);
        $this->runTest(true, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[30]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[31]->id_afiliado, $fecha);
        $this->runTest(true, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[31]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[32]->id_afiliado, $fecha);
        $this->runTest(true, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[32]->id_afiliado . '');

        $resultado = $calculadorBono->usuarioPuedeCobrarBono($id_bono, $usuarios[33]->id_afiliado, $fecha);
        $this->runTest(true, $resultado, 'Test validar si Esta disponible Para Cobrar por puntos Comisionables personales' . $usuarios[33]->id_afiliado . '');
    ...
    public function testRepartirComisionBonoRedHaciaAbajo()
    {
        ...
        $id_usuario = 10000;
        $resultado = $repartidorComisionBono->getTotalValoresTransaccionPorBonoYUsuario($id_bono, $id_usuario);
        $resultado = $resultado[0]->total;
        $this->runTest(0, $resultado, 'Test validar si entrega comisiones bono en red');

        // Nivel 1
        $id_usuario = 10001;
        $resultado = $repartidorComisionBono->getTotalValoresTransaccionPorBonoYUsuario($id_bono, $id_usuario);
        $resultado = $resultado[0]->total;
        $this->runTest(30, $resultado, 'Test validar si entrega comisiones bono en red');
        ...
        $resultado = $repartidorComisionBono->getTotalValoresTransaccionPorBonoYUsuario($id_bono, $id_usuario);
        $resultado = $resultado[0]->total;
        $this->runTest(20, $resultado, 'Test validar si entrega comisiones bono en red');
        ...
        $resultado = $repartidorComisionBono->getTotalValoresTransaccionPorBonoYUsuario($id_bono, $id_usuario);
        $resultado = $resultado[0]->total;
        $this->runTest(10, $resultado, 'Test validar si entrega comisiones bono en red');
    ...
    public function testRepartirComisionBonoDirectosHaciaAbajo()
    {
        ...
        $resultado = $repartidorComisionBono->getTotalValoresTransaccionPorBonoYUsuario($id_bono, $id_usuario);
        $resultado = $resultado[0]->total;
        $this->runTest(5, $resultado, 'Test validar si entrega comisiones bono en red');
    ...
    public function testRepartirComisionBonoRedHaciaArriba()
    {
        ...
        $this->runTest(10, $resultado, 'Test validar si entrega comisiones bono en red Hacia Arriba $');
        $resultado = $repartidorComisionBono->getIdUsuario();
        $this->runTest(10000, $resultado, 'Test validar si entrega comisiones bono en red');
        ...
        $repartidorComisionBono->setUpReparticionComision($transaccion);
        $resultado = $repartidorComisionBono->getValor();
        $this->runTest(20, $resultado, 'Test validar si entrega comisiones bono en red Hacia Arriba $');
        $resultado = $repartidorComisionBono->getIdUsuario();
        $this->runTest(10001, $resultado, 'Test validar si entrega comisiones bono en red');
        ...
        $repartidorComisionBono->setUpReparticionComision($transaccion);
        $resultado = $repartidorComisionBono->getValor();
        $this->runTest(30, $resultado, 'Test validar si entrega comisiones bono en red Hacia Arriba $');
        $resultado = $repartidorComisionBono->getIdUsuario();
        $this->runTest(10003, $resultado, 'Test validar si entrega comisiones bono en red');
        ...
        $repartidorComisionBono->setUpReparticionComision($transaccion);
        $resultado = $repartidorComisionBono->getValor();
        $this->runTest(0, $resultado, 'Test validar si entrega comisiones bono en red Hacia Arriba $');
        $resultado = $repartidorComisionBono->getIdUsuario();
        $this->runTest(10007, $resultado, 'Test validar si entrega comisiones bono en red');
    ...
    public function testRepartirComisionBonoDirectosHaciaArriba()
    {
        ...
        $repartidorComisionBono->setUpReparticionComision($transaccion);
        $resultado = $repartidorComisionBono->getValor();
        $this->runTest(10, $resultado, 'Test validar si entrega comisiones bono en Directos Hacia Arriba $');
        $resultado = $repartidorComisionBono->getIdUsuario();
        $this->runTest(10000, $resultado, 'Test validar si entrega comisiones bono en red');
        ...
        $repartidorComisionBono->setUpReparticionComision($transaccion);
        $resultado = $repartidorComisionBono->getValor();
        $this->runTest(20, $resultado, 'Test validar si entrega comisiones bono en Directos Hacia Arriba $');
        $resultado = $repartidorComisionBono->getIdUsuario();
        $this->runTest(10001, $resultado, 'Test validar si entrega comisiones bono en red');
        ...
        $repartidorComisionBono->setUpReparticionComision($transaccion);
        $resultado = $repartidorComisionBono->getValor();
        $this->runTest(30, $resultado, 'Test validar si entrega comisiones bono en Directos Hacia Arriba $');
        $resultado = $repartidorComisionBono->getIdUsuario();
        $this->runTest(10003, $resultado, 'Test validar si entrega comisiones bono en red');
        ...
        $repartidorComisionBono->setUpReparticionComision($transaccion);
        $resultado = $repartidorComisionBono->getValor();
        $this->runTest(0, $resultado, 'Test validar si entrega comisiones bono en Directos Hacia Arriba $');
        $resultado = $repartidorComisionBono->getIdUsuario();
        $this->runTest(10007, $resultado, 'Test validar si entrega comisiones bono en red');
    ...
    public function testValidarSiElBonoYaCobroFalso()
    {
        ...
        $id_bono = 50;
        $bono = new $this->bono();
        $bono->setUpBono($id_bono, $fecha);
        $resultado = $calculadorBono->isPagado($bono, $fecha);
        $this->runTest(false, $resultado, 'Test validar si el bono no sea pagado');
    ...
    public function testValidarSiUsuarioYaCobroBonoUnicoFalso()
    {
        ...
        $this->runTest(false, $resultado, 'Test validar si el bono ya se pago');
    ...
    public function testValidarSiElBonoYaCobroVerdadero()
    {
        ...
        $bono->setUpBono($id_bono);
        $resultado = $calculadorBono->isPagado($bono, $fecha);
        $this->runTest(true, $resultado, 'Test validar si el bono ya se pago');
